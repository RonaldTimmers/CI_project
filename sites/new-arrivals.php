...
<?php
    ...
    $searchThumbs = $searchQL   ->setQueryArguments( '', $shops->activeShops, $options = array( 'catlevel' => 'new', 'sort' => 'newest' ) )
                                ->buildQuery( 'category' )
                                ->setSearchMeta()
     ...
     * DEPRECEATED
     */
    //  $thumbs->set_thumbs_sphinx($db->linode, $page007->totalProducts, $page007->rangeMax, 'new', $page007->refid, null);
...
<script>
    ...
    window.cat = <?php echo json_encode('new');?>;
    ...
    window.sorting = <?php echo json_encode('newest');?>; 
</script>
